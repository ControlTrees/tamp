...
START_STATE { (object target) (location target_location) }

### RULES

#termination rule
Rule {
  { (observed target target_location) }
  { (QUIT) }
}
...
Rule {
  X, Y
  { (observing X Y) }
  { (Terminate observing X Y) (observing X Y)! }
}
