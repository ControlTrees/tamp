...
#
Rule {
  { (on block_2 block_1) (on block_1 block_3) (is block_2 block_a) (is block_1 block_b) (is block_3 block_c) (hand_empty) }
  { (QUIT) }
}

Rule {
  { (on block_3 block_1) (on block_1 block_2) (is block_3 block_a) (is block_1 block_b) (is block_1 block_c) (hand_empty) }
  { (QUIT) }
}

Rule {
  { (on block_1 block_2) (on block_2 block_3) (is block_1 block_a) (is block_2 block_b) (is block_3 block_c) (hand_empty) }
  { (QUIT) }
}

Rule {
  { (on block_3 block_2) (on block_2 block_1) (is block_3 block_a) (is block_2 block_b) (is block_1 block_c) (hand_empty) }
  { (QUIT) }
}

Rule {
  { (on block_1 block_3) (on block_3 block_2) (is block_1 block_a) (is block_3 block_b) (is block_2 block_c) (hand_empty) }
  { (QUIT) }
}

Rule {
  { (on block_2 block_3) (on block_3 block_1) (is block_2 block_a) (is block_3 block_b) (is block_1 block_c) (hand_empty) }
  { (QUIT) }
}
