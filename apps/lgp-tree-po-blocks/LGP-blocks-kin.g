...
#blocks
body block_o { type=9 size=[.1 .1 .1 .02] color=[0 1 1] }	#on the shelf
...
BELIEF_START_STATE { 
{
 shape id_3(block_3) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 0 1] }
 shape id_1(block_1) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 1 0] }
 shape id_2(block_2) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[1 0 0] }
}

{
 shape id_2(block_2) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 0 1] }
 shape id_1(block_1) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 1 0] }
 shape id_3(block_3) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[1 0 0] }
}

{
 shape id_3(block_3) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 0 1] }
 shape id_2(block_2) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 1 0] }
 shape id_1(block_1) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[1 0 0] }
}

{
 shape id_1(block_1) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 0 1] }
 shape id_2(block_2) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 1 0] }
 shape id_3(block_3) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[1 0 0] }
}
...
{
 shape id_2(block_2) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 0 1] }
 shape id_3(block_3) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[0 1 0] }
 shape id_1(block_1) { type=9 rel=<T t(0 -0.05 0.0)> size=[.1 .02 .1 .01] color=[1 0 0] }
}
