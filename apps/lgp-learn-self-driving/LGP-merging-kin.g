...
body car_1  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[0.5 0 0] type=1 }
body car_2  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[1.0 0 0] type=1 }
body car_3  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[1.0 0 0] type=1 }
body car_4  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[0.5 0 0] type=1 }
body car_5  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[0.4 0 0] type=1 }
body car_6  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[0.3 0 0] type=1 }
body car_7  { type=9 rel=<T t(0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[0.2 0 0] type=1 }
...
## Joints
joint (lane_1 car_ego)         { from=<T t( -1.25   0.01 .05 ) t(0 0 0)> to=<T > type=8 agent=true}
