...
body block_1 { type=9 rel=<T t(0 0.0 0.05)> size=[.1 .1 .1 .01] color=[0 0 0] contact }	
body block_2 { type=9 rel=<T t(0 0.0 0.05)> size=[.1 .1 .1 .01] color=[0 0 0] contact }	
body block_3 { type=9 rel=<T t(0 0.0 0.05)> size=[.1 .1 .1 .01] color=[0 0 0] contact }
...
# joint (tableC block_3)          { from=<T t( 0.15  0 .02 ) t(0 0 0)> to=<T > type=10 } 
# joint (block_3 block_1)         { from=<T t( 0.0   0 .1  ) t(0 0 0)> to=<T > type=10 } 
#()=0.4
#}
#}
