...
body block_5 { type=9 size=[.1 .1 .1 .01] color=[0 0 0] }
body block_6 { type=9 size=[.1 .1 .1 .01] color=[0 0 0] }
...
shape id_5(block_5) { type=9 rel=<T t( 0.05 0  0.0)> size=[.02 .1 .1 .01] color=[0 1 1] }
shape id_6(block_6) { type=9 rel=<T t( 0.05 0  0.0)> size=[.02 .1 .1 .01] color=[1 1 0] }
...
joint (block_3 block_5)         { from=<T t( 0.0   0 .1  ) t(0 0 0)> to=<T > type=10 } 
joint (block_4 block_6)         { from=<T t( 0.0   0 .1  ) t(0 0 0)> to=<T > type=10 }
