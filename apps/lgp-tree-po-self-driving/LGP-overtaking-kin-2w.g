...
body car_op  { type=9 rel=<T t(0.0 0.0 0.05)> size=[.2 .1 .1 .003]  color=[1 0 0] contact type=1 }
...
BELIEF_START_STATE { 
{
joint (lane_2 car_op)          { from=<T t( 2.3      0  .05 ) t(0 0 0)> to=<T >  type=3 }
}
{
joint (lane_2 car_op)          { from=<T t( 1.3      0  .05 ) t(0 0 0)> to=<T >  type=3 }
}
}
